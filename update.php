...
if ( isset($_SESSION['CurrentUser'])){
	echo "Welcome to sanguine"."$_SESSION['CurrentUser']";
...
// need to get the user's UserName from the login page==> $UserName
	...
	$query1="UPDATE [User] (Password) VALUES (?,?,?) WHERE UserName = '$_SESSION['CurrentUser']'";
    $param1= array($users_password);
	//echo $query1;
	...
	{
		$query = "UPDATE [UserDetail] (Name, Address1, Address2, PhoneNumber, Email) VALUES (?,?,?,?,?) WHERE UserName = '$_SESSION['CurrentUser']'";
		$params = array($users_name, $users_address1, $users_address2, $users_phone, $users_email);
		...
		if( $sql )
			{
				...
				$query2="UPDATE [location] (Latitude,Longitude,LastUpdatedOn) VALUES (?,?,?) WHERE UserName = '$_SESSION['CurrentUser']'";
			...
			$query3 = "UPDATE [bloodType] (Type) VALUES (?) WHERE UserName = '$_SESSION['CurrentUser']'";
			$params3 = array($blood_type);
