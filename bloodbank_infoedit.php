...
<!--div class="btn-group btn-group-justified">
  ...
  <div class="row">
  <div class="col-lg-12">
  <form class="form-horizontal" action="bloodbank_update.php?go" method="post" onsubmit="return checkPassword()">
    <fieldset>
    ...
    <!--div class="form-group">
      ...
      <!--div class="col-lg-4">
      <input type="radio" class="" name="rdoAccountType" required value='1' onchange="handleRadioChanged(this)">
